...
public class InsertResult extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            userdata.setMonth((String)session.getAttribute("month"));
            userdata.setDay((String)session.getAttribute("day"));
            ...
            UserDataDAO.getInstance().Format(userdto, userdata);

            //DBへデータの挿入
            UserDataDAO .getInstance().insert(userdto);
